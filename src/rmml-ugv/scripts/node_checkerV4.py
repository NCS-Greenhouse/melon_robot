...
class App:
    def __init__(self, root):
        ...
        self.nodes = ['/slip',
                      ...
                      '/camera/realsense2_camera_manager'] # Replace with the names of your nodes
...
if __name__ == '__main__':
    ...
    #datahub.send_single([1],device_id=hyp['device_id']['ugv_bridge'],tag_name='UGV_Power')
    ...
    #         datahub.send_single([ugv_ready],device_id=hyp['device_id']['ugv_bridge'],tag_name='UGV_Power_B')
    #         time.sleep(1)
    # finally:
    #     ugv_ready = 0
    #     datahub.send_single([ugv_ready],device_id=hyp['device_id']['ugv_bridge'],tag_name='UGV_Power_B')
    #     datahub.close_connection()
    #     time.sleep(5)  # Waiting for connection to be closing
    # while not rospy.is_shutdown():
    #     rospy.Rate(1).sleep()
    # else:
        #     ugv_ready = 0
